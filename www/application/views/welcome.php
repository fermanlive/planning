...
<!--     <meta property="og:title" content="">
    ...
    <!-- styles -->
    <link rel="stylesheet" href="<?php echo base_url('assets/buBbu_files/vendor_18435157108643434127.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/buBbu_files/fonts_8049871103083011125.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/buBbu_files/app_9729214104363342901.css') ?>">

    <!-- favicon -->
<!--     <link rel="apple-touch-icon" sizes="180x180" href="https://www.rust-lang.org/static/images/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="https://www.rust-lang.org/static/images/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="https://www.rust-lang.org/static/images/favicon-16x16.png">
    <link rel="shortcut icon" href="https://www.rust-lang.org/static/images/favicon.ico">
    <link rel="manifest" href="https://www.rust-lang.org/static/images/site.webmanifest">
    <link rel="mask-icon" href="https://www.rust-lang.org/static/images/safari-pinned-tab.svg" color="#5bbad5">
...
<section id="language-values" class="purple">
    ...
    <div class="flex-none flex-l flex-row">
      <div class="flex flex-row flex-column-l justify-between-l mw8 measure-wide-l w-100 mt5 mt2-l">
        <div class="v-top tc-l">
          <img src="./buBbu_files/cli.svg" alt="terminal" class="mw3 mw4-ns">
        </div>
...
Rust helps you maintain your app with confidence and distribute it with ease.
          ...
          <a href="https://www.rust-lang.org/what/cli" class="button button-secondary">Learn More</a>
        </div>
      </div>

      <div class="flex flex-row flex-column-l justify-between-l mw8 measure-wide-l w-100 mt5 mt2-l pl4-l">
        <div class="v-top tc-l">
          <img src="./buBbu_files/webassembly.svg" alt="gear with puzzle piece elements" class="mw3 mw4-ns">
        </div>
        <div class="v-top pl4 pl0-l pt0 pt3-l measure-wide-l flex-l flex-column-l flex-auto-l justify-between-l">
          <h3 class="tc-l">
            WebAssembly
...
Publish to npm, bundle with webpack, and you’re off to the races.
          ...
          <a href="https://www.rust-lang.org/what/wasm" class="button button-secondary">Learn More</a>
        </div>
      </div>

      <div class="flex flex-row flex-column-l justify-between-l mw8 measure-wide-l w-100 mt5 mt2-l pl4-l">
        <div class="v-top tc-l">
          <img src="./buBbu_files/networking.svg" alt="a cloud with nodes" class="mw3 mw4-ns">
        </div>
        <div class="v-top pl4 pl0-l pt0 pt3-l measure-wide-l flex-l flex-column-l flex-auto-l justify-between-l">
          <h3 class="tc-l">
            Networking
...
Rust is great for network services.
          ...
          <a href="https://www.rust-lang.org/what/networking" class="button button-secondary">Learn More</a>
        </div>
      </div>

      <div class="flex flex-row flex-column-l justify-between-l mw8 measure-wide-l w-100 mt5 mt2-l pl4-l">
        <div class="v-top tc-l">
          <img src="./buBbu_files/embedded.svg" alt="an embedded device chip" class="mw3 mw4-ns">
        </div>
        <div class="v-top pl4 pl0-l pt0 pt3-l measure-wide-l flex-l flex-column-l flex-auto-l justify-between-l">
          <h3 class="tc-l">
            Embedded
...
Rust has you covered.
          ...
          <a href="https://www.rust-lang.org/what/embedded" class="button button-secondary">Learn More</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="testimonials">
      <div class="testimonial flex-none flex-l">
        <div class="w-100 w-70-l" id="npm-testimonial">
          ...
          <p class="attribution">– Chris Dickinson, Engineer at npm, Inc</p>
        </div>
        <div class="w-100 w-30-l tc">
          <a href="https://www.npmjs.com/">
            <img src="./buBbu_files/npm.svg" alt="npm Logo" class="w-33 w-60-ns h-auto">
          </a>
        </div>
      </div>
      <hr>
      <div class="testimonial flex-none flex-l">
        <div class="w-100 w-30-l tc">
          <a href="https://www.youtube.com/watch?v=u6ZbF4apABk"><img src="./buBbu_files/yelp.png" alt="Yelp Logo" class="w-80"></a>
        </div>
        <div class="w-100 w-70-l" id="yelp-testimonial">
          ...
          <p class="attribution">– Antonio Verardi, Infrastructure Engineer</p>
        </div>
      </div>
    </div>
    <a href="https://www.rust-lang.org/production" class="button button-secondary">Learn More</a>
  </div>
</section>
  ...
  <div class="w-100 mw-none ph3 mw8-m mw9-l center f3">
    ...
    <div class="flex flex-column flex-row-l">
      <div id="read-rust" class="mw-50-l mr4-l pt0 flex flex-column justify-between-l">
        ...
        <a href="https://www.rust-lang.org/learn" class="button button-secondary">Read the book</a>
      </div>
...
<option title="Italiano (it)" value="it">Italiano (it)</option>
      ...
      <div class="flex flex-column mw8 w-100 measure-wide-l pv2 pv5-m pv2-ns ph4-m ph4-l">
        ...
        <div class="flex flex-row flex-wrap">
          <a href="https://twitter.com/rustlang"><img src="./buBbu_files/twitter.svg" alt="twitter logo" title="Twitter"></a>
          <a href="https://www.youtube.com/channel/UCaYhcUwRBNscFNUKTjgPFiA"><img class="pv2" src="./buBbu_files/youtube.svg" alt="youtube logo" title="YouTube"></a>
          <a href="https://discord.gg/rust-lang"><img src="./buBbu_files/discord.svg" alt="discord logo" title="Discord"></a>
          <a href="https://github.com/rust-lang"><img src="./buBbu_files/github.svg" alt="github logo" title="GitHub"></a>
        </div>
      </div>
...
<!--     <script src="<?php echo base_url('assets/buBbu_files/languages.js') ?>"></script> -->
